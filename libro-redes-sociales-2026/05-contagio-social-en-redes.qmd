...
**Un nodo periférico y con bajo grado puede ser más influyente que un hub** si está embebido en un vecindario denso con puentes anchos hacia otros clusters.

![Camino simple vs. camino complejo. El contagio complejo necesita avanzar por **puentes anchos**. Figura 1 de Guilbeault & Centola (2021).](figs/contagio/11-guilbeault-centola-camino-complejo.png){width="50%" fig-align="center"}
...
`netdiffuseR` es el paquete de R para difusión en redes (Valente, Vega Yon y Olivera). Tiene mucho más de lo que veremos; aquí, dos cosas: **leer** datos de encuesta y estimar el efecto de la exposición, y **simular** difusiones simples y complejas. Lo que sigue está tomado casi textualmente del [workshop de Sunbelt](https://usccana.github.io/netdiffuser-workshop/), donde hay más.
...
```{r}
#| label: fig-nd-sim
#| fig-cap: "Adoptantes acumulados en una difusión tipo enfermedad y en una conductual."
#| fig-height: 4.5
#| message: false
#| warning: false
